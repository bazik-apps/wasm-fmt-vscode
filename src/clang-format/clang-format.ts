...
export const clangFormatInit = async (context: ExtensionContext) => {
...
export const clangFormatSubscription = () => {
...
const languageMap: Record<SupportedLanguage, string> = {
	...
	proto3: "main.proto",
	proto: "main.proto",
	systemverilog: "main.sv",
	tablegen: "main.td",
	textproto: "main.pbtxt",
	verilog: "main.vl",
}

const defaultConfig = (languageId: string) => {
